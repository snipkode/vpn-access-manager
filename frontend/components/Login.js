...
export default function Login({ onLogin, appName }) {
  ...
  return (
    <div className="min-h-screen bg-[#000000] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
        ...
        <div className={`w-full bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8 sm:p-10 shadow-2xl transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-[11px] text-gray-400">Global</span>
            </div>
          </div>
        </div>
