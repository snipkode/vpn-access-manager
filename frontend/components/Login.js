  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full">
        ...
        <button
          onClick={onLogin}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-dark rounded-2xl font-semibold text-base cursor-pointer transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
        >
        ...
        {/* Footer */}
        <p className="mt-8 text-gray-medium text-sm flex items-center gap-2">
          <span>🔒</span>
